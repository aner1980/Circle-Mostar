Meteor.startup(function() {
	...
	Abilities.upsert({aid: 4}, {aid: 3, level: 1, icon: "/powerup-invis.png",  name: "Invisibility (Sample 4)", desc: "Light bends around you which grants you 95% opacity for 10 seconds.", duration: 10, bonus: 60});
	Abilities.upsert({aid: 5}, {aid: 3, level: 1, icon: "/powerup-health.png",  name: "Health Boost (Sample 5)", desc: "Gives you a burst of health; heals you for 50 radius instantly.", duration: 10, bonus: 60});
	Abilities.upsert({aid: 6}, {aid: 3, level: 1, icon: "/powerup-poison.png",  name: "Toxin (Sample 6)", desc: "Release a stash of toxic chemicals on your current position, which poisons any enemy units that pass through the field. Poison damages over time and decreases the effectiveness of healing.", duration: 10, bonus: 60});
